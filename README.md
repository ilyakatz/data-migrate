...
When using 'with_data' migrations will be run in ascending order by their version. So if you have a data migration and a schema migration with different version numbers, expect them to run in that order.
